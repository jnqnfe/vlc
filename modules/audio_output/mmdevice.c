...
static int Start(audio_output_t *aout, audio_sample_format_t *restrict fmt)
{
    ...
    for (;;)
    {
        ...
        sys->module = vlc_module_load2(s, VLC_CAP_AOUT_STREAM, modlist,
...
vlc_plugin_begin()
    ...
    set_description(N_("Windows Multimedia Device"))
    set_capability(VLC_CAP_AUDIO_OUTPUT, 150, Open, Close)

    set_subcategory(SUBCAT_AUDIO_AOUT)
    set_callbacks(Open, Close)
    add_module("mmdevice-backend", VLC_CAP_STR_AOUT_STREAM, NULL,
