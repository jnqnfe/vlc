...
vlc_plugin_begin ()
    ...
    set_shortname( N_("Linear PCM") )
    set_capability( VLC_CAP_AUDIO_DECODER, 100, OpenDecoder, CloseCommon )

    add_submodule ()
    set_shortname( N_("Linear PCM") )
    set_capability( VLC_CAP_PACKETIZER, 100, OpenPacketizer, CloseCommon )
