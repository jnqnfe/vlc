...
static const char *const profile_h264_text[] =
    { N_("decide"), N_("baseline"), N_("main"), N_("extended"), N_("high") };
...
static const char *const profile_mpeg2_text[] =
    { N_("decide"), N_("simple"), N_("main"), N_("high") };
...
static const char *const level_h264_text[] =
    { N_("decide"), "1", "1.1b", "1.2", "1.3", "2", "2.1", "2.2", "3", "3.1",
...
static const char *const level_mpeg2_text[] =
    { N_("decide"), N_("low"), N_("main"), N_("high"), N_("high1440") };
...
static const char *const target_usage_text[] =
    { N_("decide"), N_("quality"), N_("balanced"), N_("speed") };
...
vlc_plugin_begin ()
    set_description("Intel QuickSync")
    set_help(N_("Intel QuickSync for MPEG4-Part10/MPEG2 (aka H.264/H.262)"))
    set_shortname("QSV")
