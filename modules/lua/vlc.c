...
vlc_plugin_begin ()
    ...
    add_submodule ()
        ...
        set_capability( VLC_CAP_STREAM_FILTER, 302 )
    ...
    add_submodule ()
        ...
        set_capability( VLC_CAP_ART_FINDER, 10 )
    ...
    add_submodule ()
        ...
        set_capability( VLC_CAP_EXTENSION, 1 )
