...
static int Open( filter_t *p_filter )
{
    ...
    p_sys->f_lowf = var_InheritFloat( p_filter, "param-eq-lowf");
    p_sys->f_lowgain = var_InheritFloat( p_filter, "param-eq-lowgain");
    p_sys->f_highf = var_InheritFloat( p_filter, "param-eq-highf");
    p_sys->f_highgain = var_InheritFloat( p_filter, "param-eq-highgain");
 
    p_sys->f_f1 = var_InheritFloat( p_filter, "param-eq-f1");
    p_sys->f_Q1 = var_InheritFloat( p_filter, "param-eq-q1");
    p_sys->f_gain1 = var_InheritFloat( p_filter, "param-eq-gain1");
 
    p_sys->f_f2 = var_InheritFloat( p_filter, "param-eq-f2");
    p_sys->f_Q2 = var_InheritFloat( p_filter, "param-eq-q2");
    p_sys->f_gain2 = var_InheritFloat( p_filter, "param-eq-gain2");

    p_sys->f_f3 = var_InheritFloat( p_filter, "param-eq-f3");
    p_sys->f_Q3 = var_InheritFloat( p_filter, "param-eq-q3");
    p_sys->f_gain3 = var_InheritFloat( p_filter, "param-eq-gain3");
