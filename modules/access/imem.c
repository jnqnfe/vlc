...
vlc_plugin_begin()
    ...
    add_integer_with_range("imem-width", 0, 0, INT_MAX, WIDTH_TEXT, WIDTH_LONGTEXT, true)
        change_private()
        change_safe()
    add_integer_with_range("imem-height", 0, 0, INT_MAX, HEIGHT_TEXT, HEIGHT_LONGTEXT, true)
        change_private()
        change_safe()
