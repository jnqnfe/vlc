...
vlc_plugin_begin ()
#if defined (PLUGIN_NAME_IS_i420_yuy2)
    set_shortname( N_("i420 to YUY2") )
    set_description( N_("i420 to YUY2") )
...
# define vlc_CPU_capable() (true)
    ...
    set_shortname( N_("i420 to YUY2") )
    set_description( N_("i420 to YUY2") )
    set_help( N_("SSE2 accelerated conversions from " SRC_FOURCC " to " DEST_FOURCC) )
    set_capability( VLC_CAP_VIDEO_CONVERTER, 250, Activate, NULL )
# define vlc_CPU_capable() vlc_CPU_SSE2()
#elif defined (PLUGIN_NAME_IS_i420_yuy2_altivec)
    set_shortname( N_("i420 to YUY2") )
    set_description( N_("i420 to YUY2") )
    set_help( N_("AltiVec accelerated conversions from " SRC_FOURCC " to " DEST_FOURCC) )
    set_capability( VLC_CAP_VIDEO_CONVERTER, 250, Activate, NULL )
# define vlc_CPU_capable() vlc_CPU_ALTIVEC()
#elif defined (PLUGIN_NAME_IS_i420_yuy2_avx2)
    set_shortname( N_("i420 to YUY2") )
    set_description( N_("i420 to YUY2") )
    set_help( N_("AVX2 accelerated conversions from " SRC_FOURCC " to " DEST_FOURCC) )
