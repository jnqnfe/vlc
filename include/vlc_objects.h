...
vlc_object_cast(addons_finder_t)
vlc_object_cast(addons_storage_t)
vlc_object_cast(audio_output)
vlc_object_cast(audio_volume_t)
vlc_object_cast(decoder_t)
vlc_object_cast(demux_meta_t)
vlc_object_cast(encoder_t)
...
vlc_object_cast(meta_fetcher_t)
...
vlc_object_cast(sout_mux_t)
vlc_object_cast(sout_stream_t)
vlc_object_cast(spu_t)
...
vlc_object_cast(video_splitter_t)
vlc_object_cast(vlc_decoder_device)
vlc_object_cast(vlc_gl_t)
vlc_object_cast(vlc_inhibit_t)
vlc_object_cast(vlc_keystore)
vlc_object_cast(vlc_medialibrary_module_t)
vlc_object_cast(vlc_player_t)
vlc_object_cast(vlc_probe_t)
vlc_object_cast(vlc_renderer_discovery_t)
vlc_object_cast(vlc_tls_client_t)
vlc_object_cast(vlc_tls_server_t)
vlc_object_cast(vod_t)
vlc_object_cast(vout_display_t)
vlc_object_cast(vout_thread_t)
vlc_object_cast(vout_window_t)
vlc_object_cast(xml_reader_t)
