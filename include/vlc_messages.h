...
#define msg_GenericVa(o, p, fmt, ap) \
    vlc_object_vaLog(VLC_OBJECT(o), p, vlc_plugin_name, __FILE__, __LINE__, \
                     __func__, fmt, ap)

#define msg_Generic(o, p, ...) \
    vlc_object_Log(VLC_OBJECT(o), p, vlc_plugin_name, __FILE__, __LINE__, \
...
extern const char vlc_plugin_name[];
...
#define vlc_log_gen(logger, prio, ...) \
        vlc_Log(&(logger), prio, "generic", vlc_plugin_name, \
