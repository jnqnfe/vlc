...
static const cap_description_t cap_descriptions[] = {
    ...
    CAP(VLC_CAP_STREAM_FILTER,      "stream filter",    N_("Stream filter")),
    ...
    CAP(VLC_CAP_SERVICES_DISCOVERY, "services discovery", N_("Services discovery")),
    ...
    CAP(VLC_CAP_RENDERER_DISCOVERY, "renderer discovery", N_("Renderer discovery")),
    ...
    CAP(VLC_CAP_DEMUX_FILTER,       "demux filter",     N_("Demux filter")),
    ...
    CAP(VLC_CAP_STREAM_DIRECTORY,   "stream directory", N_("Stream directory")),
    CAP(VLC_CAP_STREAM_EXTRACTOR,   "stream extractor", N_("Stream extractor")),
