...
#define TOGGLE_FULLSCREEN_KEY_LONGTEXT N_("Select the hotkey to use to toggle fullscreen state on/off.")
...
#define PLAY_PAUSE_KEY_LONGTEXT N_("Select the hotkey to use to toggle between playing/paused state.")
#define PAUSE_KEY_TEXT N_("Playback pause")
#define PAUSE_KEY_LONGTEXT N_("Select the hotkey to use to pause playback.")
#define PLAY_KEY_TEXT N_("Playback play")
#define PLAY_KEY_LONGTEXT N_("Select the hotkey to use to start/resume playback.")
...
#define RATE_NORMAL_KEY_LONGTEXT N_("Select the hotkey to use for restoring the playback rate to normal.")
#define RATE_FASTER_FINE_KEY_TEXT N_("Speed faster (fine)")
#define RATE_FASTER_FINE_KEY_LONGTEXT N_("Select the hotkey to use to set fine fast forward playback.")
#define RATE_SLOWER_FINE_KEY_TEXT N_("Speed slower (fine)")
#define RATE_SLOWER_FINE_KEY_LONGTEXT N_("Select the hotkey to use to set fine slow motion playback.")
...
#define STOP_KEY_LONGTEXT N_("Select the hotkey to use to stop playback.")
#define POSITION_KEY_TEXT N_("See position")
#define POSITION_KEY_LONGTEXT N_("Select the hotkey to use to have the current time position temporarily displayed over the video.")

#define JBEXTRASHORT_KEY_TEXT N_("Backwards jump, very short amount")
#define JBEXTRASHORT_KEY_LONGTEXT N_("Select the hotkey to use to make a very short backwards jump.")
#define JBSHORT_KEY_TEXT N_("Backwards jump, short amount")
#define JBSHORT_KEY_LONGTEXT N_("Select the hotkey to use to make a short backwards jump.")
#define JBMEDIUM_KEY_TEXT N_("Backwards jump, medium amount")
#define JBMEDIUM_KEY_LONGTEXT N_("Select the hotkey to use to make a medium backwards jump.")
#define JBLONG_KEY_TEXT N_("Backwards jump, large amount")
#define JBLONG_KEY_LONGTEXT N_("Select the hotkey to use to make a long backwards jump.")

#define JFEXTRASHORT_KEY_TEXT N_("Forwards jump, very short amount")
#define JFEXTRASHORT_KEY_LONGTEXT N_("Select the hotkey to use to make a very short forwards jump.")
#define JFSHORT_KEY_TEXT N_("Forwards jump, short amount")
#define JFSHORT_KEY_LONGTEXT N_("Select the hotkey to use to make a short forwards jump.")
#define JFMEDIUM_KEY_TEXT N_("Forwards jump, medium amount")
#define JFMEDIUM_KEY_LONGTEXT N_("Select the hotkey to use to make a medium forwards jump.")
#define JFLONG_KEY_TEXT N_("Forwards jump, large amount")
#define JFLONG_KEY_LONGTEXT N_("Select the hotkey to use to make a long forwards jump.")

#define FRAME_NEXT_KEY_TEXT N_("Next frame")
#define FRAME_NEXT_KEY_LONGTEXT N_("Select the hotkey to use to jump to the next video frame.")

#define QUIT_KEY_TEXT N_("Quit")
#define QUIT_KEY_LONGTEXT N_("Select the hotkey to use to quit the application.")
#define NAV_UP_KEY_TEXT N_("Navigate up")
#define NAV_UP_KEY_LONGTEXT N_("Select the hotkey to use to move the selector up in DVD/BluRay menus / move the viewpoint up (pitch).")
#define NAV_DOWN_KEY_TEXT N_("Navigate down")
#define NAV_DOWN_KEY_LONGTEXT N_("Select the hotkey to use to move the selector down in DVD/BluRay menus / move the viewpoint down (pitch).")
#define NAV_LEFT_KEY_TEXT N_("Navigate left")
#define NAV_LEFT_KEY_LONGTEXT N_("Select the hotkey to use to move the selector left in DVD/BluRay menus / move the viewpoint left (yaw).")
#define NAV_RIGHT_KEY_TEXT N_("Navigate right")
#define NAV_RIGHT_KEY_LONGTEXT N_("Select the hotkey to use to move the selector right in DVD/BluRay menus / move the viewpoint right (yaw).")
#define NAV_ACTIVATE_KEY_TEXT N_("Navigate select")
#define NAV_ACTIVATE_KEY_LONGTEXT N_("Select the hotkey to use to activate the selected item in DVD/BluRay menus.")
#define DISC_MENU_KEY_TEXT N_("Navigate menu")
#define DISC_MENU_KEY_LONGTEXT N_("Select the hotkey to use to take you to the DVD/BluRay menu.")
#define TITLE_PREV_KEY_TEXT N_("Title previous")
#define TITLE_PREV_KEY_LONGTEXT N_("Select the hotkey to use to choose the previous title from the DVD/BluRay.")
#define TITLE_NEXT_KEY_TEXT N_("Title next")
#define TITLE_NEXT_KEY_LONGTEXT N_("Select the hotkey to use to choose the next title from the DVD/BluRay.")
#define CHAPTER_PREV_KEY_TEXT N_("Chapter previous")
#define CHAPTER_PREV_KEY_LONGTEXT N_("Select the hotkey to use to choose the previous chapter from the DVD/BluRay.")
#define CHAPTER_NEXT_KEY_TEXT N_("Chapter next")
#define CHAPTER_NEXT_KEY_LONGTEXT N_("Select the hotkey to use to choose the next chapter from the DVD/BluRay.")
#define VOL_UP_KEY_TEXT N_("Volume up")
#define VOL_UP_KEY_LONGTEXT N_("Select the hotkey to use to increase audio volume.")
#define VOL_DOWN_KEY_TEXT N_("Volume down")
#define VOL_DOWN_KEY_LONGTEXT N_("Select the hotkey to use to decrease audio volume.")
#define VOL_MUTE_KEY_TEXT N_("Volume mute/unmute toggle")
#define VOL_MUTE_KEY_LONGTEXT N_("Select the hotkey to use to toggle muted audio state on/off.")
#define SUBDELAY_UP_KEY_TEXT N_("Subtitle delay up")
#define SUBDELAY_UP_KEY_LONGTEXT N_("Select the hotkey to use to increase the subtitle delay.")
#define SUBDELAY_DOWN_KEY_TEXT N_("Subtitle delay down")
#define SUBDELAY_DOWN_KEY_LONGTEXT N_("Select the hotkey to use to decrease the subtitle delay.")
...
#define SUBTEXT_SCALE_KEY_LONGTEXT N_("Select the hotkey to use to change subtitle text scaling.")
#define SUBSYNC_MARKAUDIO_KEY_TEXT N_("Subtitle sync: bookmark audio timestamp")
#define SUBSYNC_MARKAUDIO_KEY_LONGTEXT N_("Select the hotkey to use to bookmark the audio timestamp when syncing subtitles.")
#define SUBSYNC_MARKSUB_KEY_TEXT N_("Subtitle sync: bookmark subtitle timestamp")
#define SUBSYNC_MARKSUB_KEY_LONGTEXT N_("Select the hotkey to use to bookmark the subtitle timestamp when syncing subtitles.")
#define SUBSYNC_APPLY_KEY_TEXT N_("Subtitle sync: sync audio & subtitle timestamps")
#define SUBSYNC_APPLY_KEY_LONGTEXT N_("Select the hotkey to use to synchronize bookmarked audio & subtitle timestamps.")
#define SUBSYNC_RESET_KEY_TEXT N_("Subtitle sync: reset audio & subtitle sync")
#define SUBSYNC_RESET_KEY_LONGTEXT N_("Select the hotkey to use to reset synchronization of audio & subtitle timestamps.")
#define SUBPOS_UP_KEY_TEXT N_("Subtitle position up")
#define SUBPOS_UP_KEY_LONGTEXT N_("Select the hotkey to use to move subtitles higher.")
#define SUBPOS_DOWN_KEY_TEXT N_("Subtitle position down")
#define SUBPOS_DOWN_KEY_LONGTEXT N_("Select the hotkey to use to move subtitles lower.")
#define AUDIODELAY_UP_KEY_TEXT N_("Audio delay up")
#define AUDIODELAY_UP_KEY_LONGTEXT N_("Select the hotkey to use to increase the audio delay.")
#define AUDIODELAY_DOWN_KEY_TEXT N_("Audio delay down")
#define AUDIODELAY_DOWN_KEY_LONGTEXT N_("Select the hotkey to use to decrease the audio delay.")
...
#define PLAY_BOOKMARK_KEY_LONGTEXT N_("Select the hotkey to use to play a numbered bookmark.")
...
#define SET_BOOKMARK_KEY_LONGTEXT N_("Select the hotkey to use to set a numbered playlist bookmark.")
...
#define INTF_POPUP_MENU_KEY_LONGTEXT N_("Select the hotkey to use to show the contextual popup menu.")
#define SNAP_KEY_TEXT N_("Video snapshot")
#define SNAP_KEY_LONGTEXT N_("Select the hotkey to use to take a video snapshot (saved to disk).")

#define RECORD_KEY_TEXT N_("Record toggle")
#define RECORD_KEY_LONGTEXT N_("Select the hotkey to use to start/stop the record filter.")

#define LOOP_KEY_TEXT N_("Playlist Normal/Loop/Repeat mode cycle")
#define LOOP_KEY_LONGTEXT N_("Select the hotkey to use to cycle between Normal/Loop/Repeat playlist modes.")

#define RANDOM_KEY_TEXT N_("Playlist random order toggle")
#define RANDOM_KEY_LONGTEXT N_("Select the hotkey to use to toggle random playlist playback on/off.")
