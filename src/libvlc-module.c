...
#define VOD_SERVER_LONGTEXT N_( \
    "You can select which VoD server module you want to use." )
...
#define SHOW_HIDDENFILES_LONGTEXT N_( \
        "Whether or not to ignore files starting with '.'" )
...
#define JIEXTRASHORT_TEXT N_("Very short jump length (seconds)")
#define JISHORT_TEXT N_("Short jump length (seconds)")
#define JIMEDIUM_TEXT N_("Medium jump length (seconds)")
#define JILONG_TEXT N_("Long jump length (seconds)")

#define TOGGLE_FULLSCREEN_KEY_TEXT N_("Fullscreen toggle")
#define TOGGLE_FULLSCREEN_KEY_LONGTEXT N_("Hotkey for toggling fullscreen state on/off.")
#define LEAVE_FULLSCREEN_KEY_TEXT N_("Fullscreen exit")
#define LEAVE_FULLSCREEN_KEY_LONGTEXT N_("Hotkey for exiting fullscreen state.")
#define PLAY_PAUSE_KEY_TEXT N_("Playback play/pause toggle")
#define PLAY_PAUSE_KEY_LONGTEXT N_("Hotkey for toggling between playing/paused state.")
#define PAUSE_KEY_TEXT N_("Playback pause")
#define PAUSE_KEY_LONGTEXT N_("Hotkey for pausing playback.")
#define PLAY_KEY_TEXT N_("Playback play")
#define PLAY_KEY_LONGTEXT N_("Hotkey for starting/resuming playback.")
#define FASTER_KEY_TEXT N_("Speed faster")
#define FASTER_KEY_LONGTEXT N_("Hotkey for fast forward playback.")
#define SLOWER_KEY_TEXT N_("Speed slower")
#define SLOWER_KEY_LONGTEXT N_("Hotkey for slow motion playback.")
#define RATE_NORMAL_KEY_TEXT N_("Speed normal")
#define RATE_NORMAL_KEY_LONGTEXT N_("Hotkey for restoring the playback rate to normal.")
#define RATE_FASTER_FINE_KEY_TEXT N_("Speed faster (fine)")
#define RATE_FASTER_FINE_KEY_LONGTEXT N_("Hotkey for fine fast forward playback.")
#define RATE_SLOWER_FINE_KEY_TEXT N_("Speed slower (fine)")
#define RATE_SLOWER_FINE_KEY_LONGTEXT N_("Hotkey for fine slow motion playback.")
#define NEXT_KEY_TEXT N_("Playlist next")
#define NEXT_KEY_LONGTEXT N_("Hotkey for skipping to the next item in the playlist.")
#define PREV_KEY_TEXT N_("Playlist previous")
#define PREV_KEY_LONGTEXT N_("Hotkey for skipping to the previous item in the playlist.")
#define STOP_KEY_TEXT N_("Playback stop")
#define STOP_KEY_LONGTEXT N_("Hotkey for stopping playback.")
#define POSITION_KEY_TEXT N_("See position")
#define POSITION_KEY_LONGTEXT N_("Hotkey for having the current time position temporarily displayed over the video.")

#define JBEXTRASHORT_KEY_TEXT N_("Backwards jump, very short amount")
#define JBEXTRASHORT_KEY_LONGTEXT N_("Hotkey for making a very short backwards jump.")
#define JBSHORT_KEY_TEXT N_("Backwards jump, short amount")
#define JBSHORT_KEY_LONGTEXT N_("Hotkey for making a short backwards jump.")
#define JBMEDIUM_KEY_TEXT N_("Backwards jump, medium amount")
#define JBMEDIUM_KEY_LONGTEXT N_("Hotkey for making a medium backwards jump.")
#define JBLONG_KEY_TEXT N_("Backwards jump, large amount")
#define JBLONG_KEY_LONGTEXT N_("Hotkey for making a long backwards jump.")

#define JFEXTRASHORT_KEY_TEXT N_("Forwards jump, very short amount")
#define JFEXTRASHORT_KEY_LONGTEXT N_("Hotkey for making a very short forwards jump.")
#define JFSHORT_KEY_TEXT N_("Forwards jump, short amount")
#define JFSHORT_KEY_LONGTEXT N_("Hotkey for making a short forwards jump.")
#define JFMEDIUM_KEY_TEXT N_("Forwards jump, medium amount")
#define JFMEDIUM_KEY_LONGTEXT N_("Hotkey for making a medium forwards jump.")
#define JFLONG_KEY_TEXT N_("Forwards jump, large amount")
#define JFLONG_KEY_LONGTEXT N_("Hotkey for making a long forwards jump.")

#define FRAME_NEXT_KEY_TEXT N_("Next frame")
#define FRAME_NEXT_KEY_LONGTEXT N_("Hotkey for jumping to the next video frame.")

#define QUIT_KEY_TEXT N_("Quit")
#define QUIT_KEY_LONGTEXT N_("Hotkey for quitting the application.")
#define NAV_UP_KEY_TEXT N_("Navigate up")
#define NAV_UP_KEY_LONGTEXT N_("Hotkey for moving the selector up in DVD/BluRay menus / moving the viewpoint up (pitch).")
#define NAV_DOWN_KEY_TEXT N_("Navigate down")
#define NAV_DOWN_KEY_LONGTEXT N_("Hotkey for moving the selector down in DVD/BluRay menus / moving the viewpoint down (pitch).")
#define NAV_LEFT_KEY_TEXT N_("Navigate left")
#define NAV_LEFT_KEY_LONGTEXT N_("Hotkey for moving the selector left in DVD/BluRay menus / moving the viewpoint left (yaw).")
#define NAV_RIGHT_KEY_TEXT N_("Navigate right")
#define NAV_RIGHT_KEY_LONGTEXT N_("Hotkey for moving the selector right in DVD/BluRay menus / moving the viewpoint right (yaw).")
#define NAV_ACTIVATE_KEY_TEXT N_("Navigate select")
#define NAV_ACTIVATE_KEY_LONGTEXT N_("Hotkey for activating the selected item in DVD/BluRay menus.")
#define DISC_MENU_KEY_TEXT N_("Navigate menu")
#define DISC_MENU_KEY_LONGTEXT N_("Hotkey for taking you to the DVD/BluRay menu.")
#define TITLE_PREV_KEY_TEXT N_("Title previous")
#define TITLE_PREV_KEY_LONGTEXT N_("Hotkey for choosing the previous title from the DVD/BluRay.")
#define TITLE_NEXT_KEY_TEXT N_("Title next")
#define TITLE_NEXT_KEY_LONGTEXT N_("Hotkey for choosing the next title from the DVD/BluRay.")
#define CHAPTER_PREV_KEY_TEXT N_("Chapter previous")
#define CHAPTER_PREV_KEY_LONGTEXT N_("Hotkey for choosing the previous chapter from the DVD/BluRay.")
#define CHAPTER_NEXT_KEY_TEXT N_("Chapter next")
#define CHAPTER_NEXT_KEY_LONGTEXT N_("Hotkey for choosing the next chapter from the DVD/BluRay.")
#define VOL_UP_KEY_TEXT N_("Volume up")
#define VOL_UP_KEY_LONGTEXT N_("Hotkey for increasing audio volume.")
#define VOL_DOWN_KEY_TEXT N_("Volume down")
#define VOL_DOWN_KEY_LONGTEXT N_("Hotkey for decreasing audio volume.")
#define VOL_MUTE_KEY_TEXT N_("Volume mute/unmute toggle")
#define VOL_MUTE_KEY_LONGTEXT N_("Hotkey for toggling muted audio state on/off.")
#define SUBDELAY_UP_KEY_TEXT N_("Subtitle delay up")
#define SUBDELAY_UP_KEY_LONGTEXT N_("Hotkey for increasing the subtitle delay.")
#define SUBDELAY_DOWN_KEY_TEXT N_("Subtitle delay down")
#define SUBDELAY_DOWN_KEY_LONGTEXT N_("Hotkey for decreasing the subtitle delay.")
#define SUBTEXT_SCALE_KEY_TEXT     N_("Subtitle size normal")
#define SUBTEXT_SCALEDOWN_KEY_TEXT N_("Subtitle size larger")
#define SUBTEXT_SCALEUP_KEY_TEXT   N_("Subtitle size smaller")
#define SUBTEXT_SCALE_KEY_LONGTEXT N_("Hotkey for changing subtitle text scaling.")
#define SUBSYNC_MARKAUDIO_KEY_TEXT N_("Subtitle sync: bookmark audio timestamp")
#define SUBSYNC_MARKAUDIO_KEY_LONGTEXT N_("Hotkey for bookmarking the audio timestamp when syncing subtitles.")
#define SUBSYNC_MARKSUB_KEY_TEXT N_("Subtitle sync: bookmark subtitle timestamp")
#define SUBSYNC_MARKSUB_KEY_LONGTEXT N_("Hotkey for bookmarking the subtitle timestamp when syncing subtitles.")
#define SUBSYNC_APPLY_KEY_TEXT N_("Subtitle sync: sync audio & subtitle timestamps")
#define SUBSYNC_APPLY_KEY_LONGTEXT N_("Hotkey for synchronizing bookmarked audio & subtitle timestamps.")
#define SUBSYNC_RESET_KEY_TEXT N_("Subtitle sync: reset audio & subtitle sync")
#define SUBSYNC_RESET_KEY_LONGTEXT N_("Hotkey for resetting synchronization of audio & subtitle timestamps.")
#define SUBPOS_UP_KEY_TEXT N_("Subtitle position up")
#define SUBPOS_UP_KEY_LONGTEXT N_("Hotkey for moving subtitles higher.")
#define SUBPOS_DOWN_KEY_TEXT N_("Subtitle position down")
#define SUBPOS_DOWN_KEY_LONGTEXT N_("Hotkey for moving subtitles lower.")
#define AUDIODELAY_UP_KEY_TEXT N_("Audio delay up")
#define AUDIODELAY_UP_KEY_LONGTEXT N_("Hotkey for increasing the audio delay.")
#define AUDIODELAY_DOWN_KEY_TEXT N_("Audio delay down")
#define AUDIODELAY_DOWN_KEY_LONGTEXT N_("Hotkey for decreasing the audio delay.")

#define ZOOM_QUARTER_KEY_TEXT N_("Zoom 1:4 (quarter)")
...
#define PLAY_BOOKMARK_KEY_LONGTEXT N_("Hotkey for playing a numbered bookmark.")
...
#define SET_BOOKMARK_KEY_LONGTEXT N_("Hotkey for setting a numbered playlist bookmark.")
#define PLAY_CLEAR_KEY_TEXT N_("Playlist clear")
#define PLAY_CLEAR_KEY_LONGTEXT N_("Hotkey for clearing the current playlist.")

#define AUDIO_TRACK_KEY_TEXT N_("Audio track (language) next")
#define AUDIO_TRACK_KEY_LONGTEXT N_("Hotkey for cycling through audio tracks (languages).")
#define SUBTITLE_REVERSE_TRACK_KEY_TEXT N_("Subtitle track previous")
#define SUBTITLE_REVERSE_TRACK_KEY_LONGTEXT N_("Hotkey for cycling through subtitle tracks in reverse order.")
#define SUBTITLE_TRACK_KEY_TEXT N_("Subtitle track next")
#define SUBTITLE_TRACK_KEY_LONGTEXT N_("Hotkey for cycling through subtitle tracks.")
#define SUBTITLE_TOGGLE_KEY_TEXT N_("Subtitle visibility toggle")
#define SUBTITLE_TOGGLE_KEY_LONGTEXT N_("Hotkey for toggling subtitle visibility on/off.")
#define SUBTITLE_CONTROL_SECONDARY_KEY_TEXT N_("Subtitle secondary control toggle")
#define SUBTITLE_CONTROL_SECONDARY_KEY_LONGTEXT N_("Hotkey for toggling use of original subtitle controls to manage secondary subtitles on/off.")
#define PROGRAM_SID_NEXT_KEY_TEXT N_("Program Service ID next")
#define PROGRAM_SID_NEXT_KEY_LONGTEXT N_("Hotkey for cycling through the available program Service IDs (SIDs).")
#define PROGRAM_SID_PREV_KEY_TEXT N_("Program Service ID previous")
#define PROGRAM_SID_PREV_KEY_LONGTEXT N_("Hotkey for cycling through the available program Service IDs (SIDs) in reverse.")
#define ASPECT_RATIO_KEY_TEXT N_("Source aspect ratio next")
#define ASPECT_RATIO_KEY_LONGTEXT N_("Hotkey for cycling through available source aspect ratios.")
#define CROP_FMT_KEY_TEXT N_("Video crop format next")
#define CROP_FMT_KEY_LONGTEXT N_("Hotkey for cycling through a predefined list of crop formats.")
#define TOGGLE_AUTOSCALE_KEY_TEXT N_("Autoscaling toggle")
#define TOGGLE_AUTOSCALE_KEY_LONGTEXT N_("Hotkey for toggling autoscaling on/off.")
#define SCALE_UP_KEY_TEXT N_("Scale factor increase")
#define SCALE_UP_KEY_LONGTEXT N_("Hotkey for increasing the scale factor.")
#define SCALE_DOWN_KEY_TEXT N_("Scale factor decrease")
#define SCALE_DOWN_KEY_LONGTEXT N_("Hotkey for decreasing the scale factor.")
#define DEINTERLACE_KEY_TEXT N_("Deinterlacing toggle")
#define DEINTERLACE_KEY_LONGTEXT N_("Hotkey for toggling deinterlacing on/off.")
#define DEINTERLACE_MODE_KEY_TEXT N_("Deinterlace mode next")
#define DEINTERLACE_MODE_KEY_LONGTEXT N_("Hotkey for cycling through deinterlace modes.")
#define INTF_TOGGLE_FSC_KEY_TEXT N_("Fullscreen controls visibility toggle")
#define INTF_TOGGLE_FSC_KEY_LONGTEXT N_("Hotkey for toggling visibility of controls in fullscreen mode on/off.")
#define INTF_BOSS_KEY_TEXT N_("Boss state toggle")
#define INTF_BOSS_KEY_LONGTEXT N_("Hotkey for toggling 'boss mode' on/off. Boss mode hides the interface and pauses playback.")
#define INTF_POPUP_MENU_KEY_TEXT N_("Context menu")
#define INTF_POPUP_MENU_KEY_LONGTEXT N_("Hotkey for showing the contextual popup menu.")
#define SNAP_KEY_TEXT N_("Video snapshot")
#define SNAP_KEY_LONGTEXT N_("Hotkey for taking a video snapshot (saved to disk).")

#define RECORD_KEY_TEXT N_("Record toggle")
#define RECORD_KEY_LONGTEXT N_("Hotkey for starting/stopping the record filter.")

#define LOOP_KEY_TEXT N_("Playlist Normal/Loop/Repeat mode cycle")
#define LOOP_KEY_LONGTEXT N_("Hotkey for cycling between Normal/Loop/Repeat playlist modes.")

#define RANDOM_KEY_TEXT N_("Playlist random order toggle")
#define RANDOM_KEY_LONGTEXT N_("Hotkey for toggling random playlist playback on/off.")

#define ZOOM_KEY_TEXT N_("Zoom in")
#define UNZOOM_KEY_TEXT N_("Zoom out")
#define ZOOM_KEY_LONGTEXT N_("Hotkey for zooming in (closer).")
#define UNZOOM_KEY_LONGTEXT N_("Hotkey for zooming out (unzooming).")

#define CROP_TOP_KEY_TEXT N_("Crop one pixel, top")
#define CROP_LEFT_KEY_TEXT N_("Crop one pixel, left")
#define CROP_BOTTOM_KEY_TEXT N_("Crop one pixel, bottom")
#define CROP_RIGHT_KEY_TEXT N_("Crop one pixel, right")

#define UNCROP_TOP_KEY_TEXT N_("Uncrop one pixel, top")
#define UNCROP_LEFT_KEY_TEXT N_("Uncrop one pixel, left")
#define UNCROP_BOTTOM_KEY_TEXT N_("Uncrop one pixel, bottom")
#define UNCROP_RIGHT_KEY_TEXT N_("Uncrop one pixel, right")

#define CROP_KEY_LONGTEXT N_("Hotkey for cropping one pixel from a certain edge.")
#define UNCROP_KEY_LONGTEXT N_("Hotkey for uncropping one pixel from a certain edge.")

/* 360° Viewpoint */
#define VIEWPOINT_FOV_IN_KEY_TEXT N_("Viewpoint (360°) field of view shrink")
#define VIEWPOINT_FOV_IN_KEY_LONGTEXT N_("Hotkey for shrinking the viewpoint (360°) field of view.")
#define VIEWPOINT_FOV_OUT_KEY_TEXT N_("Viewpoint (360°) field of view expand")
#define VIEWPOINT_FOV_OUT_KEY_LONGTEXT N_("Hotkey for expanding the viewpoint (360°) field of view.")
#define VIEWPOINT_ROLL_CLOCK_KEY_TEXT N_("Viewpoint (360°) clockwise roll")
#define VIEWPOINT_ROLL_CLOCK_KEY_LONGTEXT N_("Hotkey for viewpoint (360°) clockwise roll.")
#define VIEWPOINT_ROLL_ANTICLOCK_KEY_TEXT N_("Viewpoint (360°) anti-clockwise roll")
#define VIEWPOINT_ROLL_ANTICLOCK_KEY_LONGTEXT N_("Hotkey for viewpoint (360°) anti-clockwise roll.")

#define WALLPAPER_KEY_TEXT N_("Wallpaper mode toggle")
#define WALLPAPER_KEY_LONGTEXT N_("Hotkey for toggling wallpaper mode on/off.")

#define AUDIO_DEVICE_CYCLE_KEY_TEXT N_("Audio device next")
#define AUDIO_DEVICE_CYCLE_KEY_LONGTEXT N_("Hotkey for cycling through audio devices.")
 ...
 * add_module( option_name, psz_value, capability,
 *             N_(text), N_(longtext) )
...
vlc_plugin_begin ()
    ...
    set_capability( VLC_CAP_CORE, 0, NULL, NULL )
    ...
    add_module_list("audio-filter", VLC_CAP_AUDIO_FILTER, NULL,
                    AUDIO_FILTER_TEXT, AUDIO_FILTER_LONGTEXT)
    set_subcategory( SUBCAT_AUDIO_VISUAL )
    add_module("audio-visual", VLC_CAP_VISUALIZATION, "none",
               AUDIO_VISUAL_TEXT, AUDIO_VISUAL_LONGTEXT)

    set_subcategory( SUBCAT_AUDIO_RESAMPLER )
    add_module("audio-resampler", VLC_CAP_AUDIO_RESAMPLER, NULL,
    ...
    add_bool( "embedded-video", true, EMBEDDED_TEXT, EMBEDDED_LONGTEXT,
              true )
    add_bool( "xlib", true, NULL, NULL, true )
        change_private ()
    ...
    add_module("vout", VLC_CAP_VOUT_DISPLAY, NULL, VOUT_TEXT, VOUT_LONGTEXT)
        change_short('V')

    set_subcategory( SUBCAT_VIDEO_VFILTER )
    add_module_list("video-filter", VLC_CAP_VIDEO_FILTER, NULL,
    ...
    add_module("text-renderer", VLC_CAP_TEXT_RENDERER, NULL,
    ...
    add_integer_with_range( "sub-autodetect-fuzzy", 3, 0, 4,
...
#   define SUB_PATH "./Subtitles, ./subtitles, ./Subs, ./subs"
    ...
    add_module_list("sub-source", VLC_CAP_SUB_SOURCE, NULL,
                    SUB_SOURCE_TEXT, SUB_SOURCE_LONGTEXT)
    add_module_list("sub-filter", VLC_CAP_SUB_FILTER, NULL,
    ...
    add_string( "programs", "",
        ...
        change_safe ()
    add_integer_with_range( "video-track", -1, -1, INT_MAX,
                 INPUT_VIDEOTRACK_TEXT, INPUT_VIDEOTRACK_LONGTEXT, true )
        change_safe ()
    add_integer_with_range( "audio-track", -1, -1, INT_MAX,
                 INPUT_AUDIOTRACK_TEXT, INPUT_AUDIOTRACK_LONGTEXT, true )
        change_safe ()
    add_integer_with_range( "sub-track", -1, -1, INT_MAX,
    ...
    add_module("access", VLC_CAP_ACCESS, NULL, ACCESS_TEXT, ACCESS_LONGTEXT)

    set_subcategory( SUBCAT_INPUT_DEMUX )

    add_module("demux", VLC_CAP_DEMUX, NULL, DEMUX_TEXT, DEMUX_LONGTEXT)
    ...
    add_module_list("stream-filter", VLC_CAP_STREAM_FILTER, NULL,
    ...
    add_module("mux", VLC_CAP_SOUT_MUX, NULL, MUX_TEXT, MUX_LONGTEXT)
    set_subcategory( SUBCAT_SOUT_ACO )
    add_module("access-output", VLC_CAP_SOUT_ACCESS, NULL,
    ...
    add_module("packetizer", VLC_CAP_PACKETIZER, NULL,
    ...
    add_module("vod-server", VLC_CAP_VOD_SERVER, NULL,
...
#define CLOCK_SOURCE_TEXT N_("Clock source")
    ...
    add_integer( "verbose", VLC_MSG_ERR, VERBOSE_TEXT, VERBOSE_LONGTEXT, false )
        change_integer_list( pi_verbosity_values, ppsz_verbosity_descriptions )
        change_integer_range( VLC_MSG_INFO, VLC_MSG_DBG + 3 )
        change_short('v')
        change_volatile ()
#if !defined(_WIN32) && !defined(__OS2__)
    add_bool( "daemon", false, DAEMON_TEXT, DAEMON_LONGTEXT, true )
        change_short('d')
...
#   define KEY_PLAY_CLEAR         "Ctrl+w"
    ...
    add_key("key-disc-menu", KEY_DISC_MENU, DISC_MENU_KEY_TEXT, DISC_MENU_KEY_LONGTEXT)
    add_key("key-title-prev", KEY_TITLE_PREV,
            TITLE_PREV_KEY_TEXT, TITLE_PREV_KEY_LONGTEXT)
    add_key("key-title-next", KEY_TITLE_NEXT,
            TITLE_NEXT_KEY_TEXT, TITLE_NEXT_KEY_LONGTEXT)
    add_key("key-chapter-prev", KEY_CHAPTER_PREV,
            CHAPTER_PREV_KEY_TEXT, CHAPTER_PREV_KEY_LONGTEXT)
    add_key("key-chapter-next", KEY_CHAPTER_NEXT,
            CHAPTER_NEXT_KEY_TEXT, CHAPTER_NEXT_KEY_LONGTEXT)
    ...
    add_integer( "short-jump-size", 10, JISHORT_TEXT, NULL, false )
    add_integer( "medium-jump-size", 60, JIMEDIUM_TEXT, NULL, false )
    add_integer( "long-jump-size", 300, JILONG_TEXT, NULL, false )
...
#define MODULE_TEXT \
    N_("Print help on a specific module (can be combined with --help-verbose). " \
       "Prefix the module name with = for strict matches.")
...
#define VERSION_TEXT \
    ...
    add_info( "help", HELP_TEXT, NULL )
        change_short( 'h' )
    add_info( "longhelp", LONGHELP_TEXT, NULL )
    add_info( "full-help", FULL_HELP_TEXT, NULL )
        change_short( 'H' )
    add_bool( "help-verbose", false, HELP_VERBOSE_TEXT, NULL, false )
        change_volatile ()
    add_info( "list", LIST_TEXT, NULL )
        change_short( 'l' )
    add_info( "list-verbose", LIST_VERBOSE_TEXT, NULL )
    add_string( "module", NULL, MODULE_TEXT, NULL, false )
        change_short( 'p' )
        change_volatile ()
    add_bool( "ignore-config", true, IGNORE_CONFIG_TEXT, NULL, false )
        change_volatile ()
    add_bool( "reset-config", false, RESET_CONFIG_TEXT, NULL, false )
        change_volatile ()
#ifdef HAVE_DYNAMIC_PLUGINS
    add_bool( "reset-plugins-cache", false,
              RESET_PLUGINS_CACHE_TEXT, NULL, false )
        change_volatile ()
#endif
    add_info( "version", VERSION_TEXT, NULL )
    add_string( "config", NULL, CONFIG_TEXT, NULL, false )
        change_volatile ()

    /* since 4.0.0 */
    add_obsolete_info( "no-help" )
    add_obsolete_info( "nohelp" )
    add_obsolete_info( "no-full-help" )
    add_obsolete_info( "nofull-help" )
    add_obsolete_info( "no-longhelp" )
    add_obsolete_info( "nolonghelp" )
    add_obsolete_info( "no-list" )
    add_obsolete_info( "nolist" )
    add_obsolete_info( "no-list-verbose" )
    add_obsolete_info( "nolist-verbose" )
